 ...
 */
final class Version20240612074239 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achete (Id_Produit INT NOT NULL, Id_Commande INT NOT NULL, quantite INT NOT NULL, INDEX idx_fk_id_commande_achete (Id_Commande), INDEX idx_fk_id_produit_achete (Id_Produit), PRIMARY KEY(Id_Produit, Id_Commande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE livre (Id_Produit INT NOT NULL, Id_BonLivraison INT NOT NULL, quantite INT NOT NULL, INDEX idx_fk_id_bonlivraison_livre (Id_BonLivraison), INDEX idx_fk_id_produit_livre (Id_Produit), PRIMARY KEY(Id_Produit, Id_BonLivraison)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE souscategorie (Id_Souscategorie INT AUTO_INCREMENT NOT NULL, Libelle_court VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Photo BLOB DEFAULT NULL, Id_Categorie INT NOT NULL, INDEX FK_Categorie_Souscategorie (Id_Categorie), INDEX idx_id_souscategorie (Id_Souscategorie), PRIMARY KEY(Id_Souscategorie)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
